...
export default function MyProfile() {
  return (
    <>
      <div className="w-[250px] bg-white fixed right-4 top-4 bottom-4 shadow-md rounded-md p-7">
        ...
        <div className="__info text-sm mt-7">
          ...
          <div className="flex items-center gap-3 my-3">
            ...
            <div>
              ...
              <p className="font-medium text-black mb-3">Rajshahi Bangladesh</p>
            </div>
          </div>
