    ...
    return (
      <>
        <div className="join mt-10">
          <Link href={`${nextLink}?page=1`} className="join-item btn hover:bg-brandColor/10 hover:text-brandColor border-0">
            <svg
          ...
          <Link href={`${nextLink}?page=${Math.ceil(count / 10)}`} className="join-item btn hover:bg-brandColor/20 hover:text-brandColor border-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
